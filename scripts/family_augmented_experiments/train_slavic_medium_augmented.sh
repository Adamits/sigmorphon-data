#! /bin/sh
#Train one model for all Slavic languages, and augment to be ~ 52000 training examples

ROOT="$1"
SETTING="medium"
FN="slavic"
LANGSTRING="serbo-croatian polish lithuanian russian bulgarian slovene lower-sorbian slovak czech latvian ukrainian macedonian"
FACTOR="4"
EPOCHS="20"
