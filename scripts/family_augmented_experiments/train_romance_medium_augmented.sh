#! /bin/sh
#Train one model for all Romance languages, and augment to be ~ 52000 training examples

ROOT="$1"
SETTING="medium"
FN="romance"
LANGSTRING="spanish catalan french portuguese italian romanian latin"
FACTOR="8"
EPOCHS="20"
