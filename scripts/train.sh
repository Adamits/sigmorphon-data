...
python "$ROOT"/sigmorphon-data/scripts/conll2onmt.py "$ROOT"/sigmorphon-data/data/"$LANG"-train-"$SETTING" "train" "$ROOT"/sigmorphon-data/ONMT_data "$LANG"-"$SETTING"
python "$ROOT"/sigmorphon-data/scripts/conll2onmt.py "$ROOT"/sigmorphon-data/data/"$LANG"-dev-"$SETTING" "dev" "$ROOT"/sigmorphon-data/ONMT_data "$LANG"-"$SETTING"
